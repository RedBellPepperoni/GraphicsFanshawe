...

{
	...
	bool ShaderManager::m_loadSourceFromFile(ShaderFeeney& shader)
	{
	...
	bool ShaderManager::m_compileShaderFromSource(ShaderManager::ShaderFeeney& shader, std::string& error)
	{
		error = "";
		...
		ShaderFeeney& fragShader)
	{
		...
		vertexShad.shaderType = ShaderFeeney::VERTEX_SHADER;
		...
		fragShader.shaderType = ShaderFeeney::FRAGMENT_SHADER;
