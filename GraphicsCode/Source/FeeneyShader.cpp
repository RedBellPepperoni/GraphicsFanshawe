...
{
	ShaderManager::ShaderFeeney::ShaderFeeney()
	{
		this->ID = 0;
		this->shaderType = ShaderFeeney::UNKNOWN;
		return;
	}
	...
	std::string ShaderManager::ShaderFeeney::getShaderTypeString(void)
	{
		switch (this->shaderType)
		{
		case ShaderFeeney::VERTEX_SHADER:
			return "VERTEX_SHADER";
			break;
		case ShaderFeeney::FRAGMENT_SHADER:
			return "FRAGMENT_SHADER";
			break;
		case ShaderFeeney::UNKNOWN:
		default:
	...
	bool ShaderManager::cShaderProgram::LoadUniformLocation(std::string variableName)
	{
		// 
	...
	int ShaderManager::cShaderProgram::getUniformID_From_Name(std::string name)
	{
		std::map< std::string /*name of uniform variable*/,
