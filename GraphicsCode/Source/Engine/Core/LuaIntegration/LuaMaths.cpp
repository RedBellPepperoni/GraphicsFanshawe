    ...
    using namespace Components;
		...
		void BindLuaMaths(sol::state& state)
		{
            ...
            (
                ...
                "GetScale", & Components::Transform::GetScale,
                "GetRotation", & Components::Transform::GetRotation,
                "GetEularRotation", & Components::Transform::GetEulerRotation,
                "GetPosition", & Components::Transform::GetPosition,
